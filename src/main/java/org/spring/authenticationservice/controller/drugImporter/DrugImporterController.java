 ...
 * This controller handles registration, profile management, and administrative
 * functions
...
public class DrugImporterController {
    ...
    // Define logger manually instead of using Lombok's @Slf4j to avoid compilation
    // issues
     ...
     *
     * @param request The registration data including personal info and document
     *                URLs
